...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create Sport Events</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('sport-events.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="eventDate" type="date" class="form-control @error('eventDate') is-invalid @enderror" name="eventDate" value="{{ old('eventDate') }}" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="eventType" type="text" class="form-control @error('eventType') is-invalid @enderror" name="eventType" value="{{ old('eventType') }}" autofocus>
                            ...
                            <div class="col-md-6">
                                <select name="organizerId" id="organizerId" class="form-select @error('organizerId') is-invalid @enderror">
                                    ...
                                    @foreach($organizers as $organizer)
                                        <option value="{{ $organizer["id"] }}" {{ old('organizerId') == $organizer["id"] ? "selected" : "" }}>({{ $organizer["id"] }}) {{ $organizer["organizerName"] }}</option>
                                    @endforeach
                                </select>
